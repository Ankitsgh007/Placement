...
// Calculate the sum of corresponding elements of two 2D arrays
...
/*  pseudocode
 ...
 DECLARE sumArr: Array[rows][cols] of Integer
 ...
 PRINT "Sum of corresponding elements in the two arrays:"
 FOR i FROM 0 TO rows-1 DO
    FOR j FROM 0 TO cols-1 DO
        PRINT sumArr[i][j] + " "
    END FOR
...
public class sumOf2Array {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Sum of corresponding elements in the two arrays:");
        for(int i=0; i<rows; i++){
            for(int j=0; j<cols; j++){
